...
export const posts: Post[] = [
  {
    slug: 'how-ai-assistants-find-recommend-security-brands',
    title: 'How AI Assistants Find & Recommend Security Brands',
    category: 'AIO/AEO',
    date: '2026-06-20',
    read: '10 min',
    excerpt: 'ChatGPT, Gemini and Perplexity now shortlist vendors for security buyers. Here is how AI engines discover, evaluate and recommend brands — and the signals your company needs to build.',
    metaTitle: 'How AI Assistants Find & Recommend Security Brands | SecurityBlogs',
    metaDescription: 'A practical guide to AI visibility for security companies — how ChatGPT, Gemini and Perplexity discover, trust and recommend brands, and the signals you need to build.',
    body: '<p>ChatGPT, Gemini and Perplexity are now shortlisting vendors for security buyers. See the full guide for a comprehensive breakdown of entity signals, citable content and schema markup that earns AI recommendations.</p>',
  },
  {
    slug: 'local-seo-security-companies-australia-2026',
    title: 'Local SEO for Security Companies in Australia: The 2026 Guide',
    category: 'SEO',
    date: '2026-06-22',
    read: '11 min',
    excerpt: 'The complete playbook for winning the Google map pack as a security installer in Australia — GBP mastery, service-area pages, NAP consistency, reviews and local schema.',
    metaTitle: 'Local SEO for Security Companies in Australia: The 2026 Guide | SecurityBlogs',
    metaDescription: 'A complete local SEO guide for Australian security companies — Google Business Profile mastery, service-area pages, NAP consistency, reviews and local schema that win the map pack.',
    body: '<p>The complete playbook for winning Google Maps and local results as a security installer or service business in Australia. See the full guide for GBP optimisation, service-area page frameworks, AU directory listings and review strategy.</p>',
  },
  {
    slug: 'content-marketing-security-companies-framework',
    title: 'Content Marketing for Security Companies: The Complete Framework',
    category: 'SEO',
    date: '2026-06-24',
    read: '10 min',
    excerpt: 'A practical framework for security brands — topic clusters, buyer journey mapping, E-E-A-T signals and content structured to rank on Google and get cited by AI assistants.',
    metaTitle: 'Content Marketing for Security Companies: The Complete Framework | SecurityBlogs',
    metaDescription: 'A practical content marketing framework for security companies — topic clusters, buyer journey mapping, E-E-A-T signals and AI-ready formatting that builds rankings and citations.',
    body: '<p>Content marketing for security companies requires a different approach than most industries. See the full guide for topic cluster planning, buyer journey mapping, content types that earn both rankings and AI citations, and sustainable publishing cadences.</p>',
  },
  {
...
export const publicPosts = posts.filter((p) => p.visible !== false)
