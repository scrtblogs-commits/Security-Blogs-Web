# PAGE_28_CASE_STUDIES

**URL:** `https://securityblogs.com.au/case-studies/`
**Airtable table:** `SB · 28 · Case Studies Index`
**Page kind:** listing
**Sections in spec:** 4
...
Grid of all published case studies. Each card links to /case-studies/<slug>/.
...
|---|---|---|
| 1 | Hero | hero |
| 2 | Case study grid | grid (server) |
| 3 | Filter chips | rich-text |
| 4 | CTA band | cta-band |
...
| Table | Use |
|---|---|
| `SB · 28 · Case Studies Index` | Per-section spec for `/case-studies/` (one row per section) |
...
| `GET /api/case-studies?where[status][equals]=published` | GET | ISR 60s | Case study list |
...
| Component | Purpose |
|---|---|
| `app/case-studies/page.tsx` | Server component — fetches CMS data, renders |
| `app/case-studies/CaseGrid.tsx` | Server component — list rendering |
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/case-studies/page.tsx` if still hardcoded). Wait for ISR.
...
*End of PAGE_28_CASE_STUDIES.md*
