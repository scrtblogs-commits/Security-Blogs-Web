# PAGE_36_CONTENT_GUIDELINES

**URL:** `https://securityblogs.com.au/content-guidelines/`
**Airtable table:** `SB · 36 · Content Guidelines`
**Page kind:** legal
**Sections in spec:** 4
...
Editorial standards for guest posts + sponsored content.
...
|---|---|---|
| 1 | Hero | hero |
| 2 | Guidelines (rich-text) | rich-text |
| 3 | Submission flow | rich-text |
| 4 | Contact info | rich-text |

## Airtable Tables

| Table | Use |
|---|---|
| `SB · 36 · Content Guidelines` | Per-section spec for `/content-guidelines/` (one row per section) |
...
|---|---|---|---|
| `GET /api/pages?where[slug][equals]=content-guidelines` | GET | ISR 60s | Page record + modules |
...
| Component | Purpose |
|---|---|
| `app/content-guidelines/page.tsx` | Server component — fetches CMS data, renders |
...
2. Navigate to `/content-guidelines/`
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/content-guidelines/page.tsx` if still hardcoded). Wait for ISR.
...
*End of PAGE_36_CONTENT_GUIDELINES.md*
