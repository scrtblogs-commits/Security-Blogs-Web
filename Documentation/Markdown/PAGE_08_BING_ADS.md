...
**URL:** `https://securityblogs.com.au/services/bing-ads/`
**Airtable table:** `SB · 08 · Bing Ads / Microsoft Ads`
**Page kind:** detail
**Sections in spec:** 8
...
Service detail for Microsoft Bing Ads. CPC comparison, LinkedIn audience targeting (Microsoft owns LinkedIn).
...
|---|---|---|
| 1 | Hero | hero |
| 2 | CPC comparison | rich-text |
| 3 | LinkedIn audience targeting | rich-text |
...
| Table | Use |
|---|---|
| `SB · 08 · Bing Ads / Microsoft Ads` | Per-section spec for `/services/bing-ads/` (one row per section) |
...
|---|---|---|---|
| `GET /api/services?where[slug][equals]=bing-ads` | GET | ISR 60s | Service record |
...
### `GET /api/services?where[slug][equals]=bing-ads`
...
| Component | Purpose |
|---|---|
| `app/services/bing-ads/page.tsx` | Server component — fetches CMS data, renders |
| `app/services/bing-ads/*.tsx` | Component used on this page |
...
2. Navigate to `/services/bing-ads/`
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/services/bing-ads/page.tsx` if still hardcoded). Wait for ISR.
