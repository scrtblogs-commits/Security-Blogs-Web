...
**URL:** `https://securityblogs.com.au/services/web-design/`
**Airtable table:** `SB · 09 · Web Design`
**Page kind:** detail
**Sections in spec:** 8
...
Service detail for Web Design. Browser mock, WP editor mock, Core Web Vitals, Clarity heatmap.
...
|---|---|---|
| 1 | Hero | hero |
| 2 | Browser mock | rich-text |
| 3 | CWV preview | rich-text |
...
| Table | Use |
|---|---|
| `SB · 09 · Web Design` | Per-section spec for `/services/web-design/` (one row per section) |
...
|---|---|---|---|
| `GET /api/services?where[slug][equals]=web-design` | GET | ISR 60s | Service record |
...
### `GET /api/services?where[slug][equals]=web-design`
...
| Component | Purpose |
|---|---|
| `app/services/web-design/page.tsx` | Server component — fetches CMS data, renders |
| `app/services/web-design/*.tsx` | Component used on this page |
...
2. Navigate to `/services/web-design/`
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/services/web-design/page.tsx` if still hardcoded). Wait for ISR.
