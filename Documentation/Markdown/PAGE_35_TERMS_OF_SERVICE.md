# PAGE_35_TERMS_OF_SERVICE

**URL:** `https://securityblogs.com.au/terms-of-service/`
**Airtable table:** `SB · 35 · Terms of Service`
**Page kind:** legal
**Sections in spec:** 4
...
Terms of service / terms of use for the website + paid services.
...
|---|---|---|
| 1 | Hero | hero |
| 2 | Sections (rich-text) | rich-text |
| 3 | Contact info | rich-text |
| 4 | Last updated date | rich-text |

## Airtable Tables

| Table | Use |
|---|---|
| `SB · 35 · Terms of Service` | Per-section spec for `/terms-of-service/` (one row per section) |
...
|---|---|---|---|
| `GET /api/pages?where[slug][equals]=terms-of-service` | GET | ISR 60s | Page record + modules |
...
| Component | Purpose |
|---|---|
| `app/terms-of-service/page.tsx (TBD if exists; verify before edit)` | Server component — fetches CMS data, renders |
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/terms-of-service/page.tsx` if still hardcoded). Wait for ISR.
...
*End of PAGE_35_TERMS_OF_SERVICE.md*
