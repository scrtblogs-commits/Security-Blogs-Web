# PAGE_23_PRICING_GUIDELINES

**URL:** `https://securityblogs.com.au/publish-with-us/pricing-guidelines/`
**Airtable table:** `SB · 23 · Pricing & Guidelines`
**Page kind:** landing
**Sections in spec:** 4
...
Master rate card. Lists every publish-with-us option with starting price + lead time.
...
|---|---|---|
| 1 | Hero | hero |
| 2 | Rate card table | tabs (client) |
| 3 | Editorial guidelines | rich-text |
| 4 | CTA band | cta-band |
...
| Table | Use |
|---|---|
| `SB · 23 · Pricing & Guidelines` | Per-section spec for `/publish-with-us/pricing-guidelines/` (one row per section) |
...
|---|---|---|---|
| `GET /api/pages?where[slug][equals]=pricing-guidelines` | GET | ISR 60s | Page record + modules |
...
| Component | Purpose |
|---|---|
| `app/publish-with-us/pricing-guidelines/page.tsx` | Server component — fetches CMS data, renders |
...
2. Navigate to `/publish-with-us/pricing-guidelines/`
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/publish-with-us/pricing-guidelines/page.tsx` if still hardcoded). Wait for ISR.
...
*End of PAGE_23_PRICING_GUIDELINES.md*
