# PAGE_12_DEFINITIONS_GLOSSARY

**URL:** `https://securityblogs.com.au/knowledge-hub/definitions-glossary/`
**Airtable table:** `SB · 12 · Definitions & Glossary`
**Page kind:** landing
**Sections in spec:** 4
...
A–Z glossary of security + SEO terms.
...
|---|---|---|
| 1 | Hero | hero |
| 2 | A-Z anchors | rich-text |
| 3 | Term cards | grid (server) |
| 4 | CTA band | cta-band |
...
| Table | Use |
|---|---|
| `SB · 12 · Definitions & Glossary` | Per-section spec for `/knowledge-hub/definitions-glossary/` (one row per section) |
...
|---|---|---|---|
| `GET /api/pages?where[slug][equals]=definitions-glossary` | GET | ISR 60s | Page record + modules |
...
| Component | Purpose |
|---|---|
| `app/knowledge-hub/definitions-glossary/page.tsx` | Server component — fetches CMS data, renders |
...
2. Navigate to `/knowledge-hub/definitions-glossary/`
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/knowledge-hub/definitions-glossary/page.tsx` if still hardcoded). Wait for ISR.
...
*End of PAGE_12_DEFINITIONS_GLOSSARY.md*
