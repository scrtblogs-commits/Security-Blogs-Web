# PAGE_03_SECURITY_SEO

**URL:** `https://securityblogs.com.au/services/security-seo/`
**Airtable table:** `SB · 03 · Security SEO`
**Page kind:** detail
**Sections in spec:** 6
...
Service detail page for the Security SEO offering. Hero, capabilities (with previewVariants), process, stats, FAQs, benefits.
...
|---|---|---|
| 1 | Hero | hero |
| 2 | Capabilities grid | capabilities |
| 3 | Process steps | process-steps |
| 4 | Stat band | stats |
| 5 | FAQs | faqs |
| 6 | Benefits + CTA band | cta-band |

## Airtable Tables

| Table | Use |
|---|---|
| `SB · 03 · Security SEO` | Per-section spec for `/services/security-seo/` (one row per section) |
...
|---|---|---|---|
| `GET /api/services?where[slug][equals]=security-seo` | GET | ISR 60s | Service record |
...
### `GET /api/services?where[slug][equals]=security-seo`
...
| Component | Purpose |
|---|---|
| `app/services/security-seo/page.tsx` | Server component — fetches CMS data, renders |
| `app/services/security-seo/*.tsx` | Component used on this page |
| `components/modules/blocks/CapabilitiesBlock.tsx` | Component used on this page |
...
2. Navigate to `/services/security-seo/`
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/services/security-seo/page.tsx` if still hardcoded). Wait for ISR.
...
*End of PAGE_03_SECURITY_SEO.md*
