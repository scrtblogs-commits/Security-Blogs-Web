# PAGE_16_SECURITY_INDUSTRY_SEO

**URL:** `https://securityblogs.com.au/knowledge-hub/security-industry-seo/`
**Airtable table:** `SB · 16 · Security Industry SEO (Pillar)`
**Page kind:** landing
**Sections in spec:** 4
...
Pillar page linking together every security-industry SEO topic.
...
|---|---|---|
| 1 | Hero | hero |
| 2 | Topic clusters | rich-text |
| 3 | Featured posts | rich-text |
| 4 | CTA band | cta-band |
...
| Table | Use |
|---|---|
| `SB · 16 · Security Industry SEO (Pillar)` | Per-section spec for `/knowledge-hub/security-industry-seo/` (one row per section) |
...
|---|---|---|---|
| `GET /api/pages?where[slug][equals]=security-industry-seo` | GET | ISR 60s | Page record + modules |
...
```json
{
  "docs": [{
    "id": "rec…",
    "slug": "security-industry-seo",
    "title": "Security Industry SEO (Pillar)",
    "modules": [
...
| Component | Purpose |
|---|---|
| `app/knowledge-hub/security-industry-seo/page.tsx` | Server component — fetches CMS data, renders |
...
2. Navigate to `/knowledge-hub/security-industry-seo/`
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/knowledge-hub/security-industry-seo/page.tsx` if still hardcoded). Wait for ISR.
...
*End of PAGE_16_SECURITY_INDUSTRY_SEO.md*
