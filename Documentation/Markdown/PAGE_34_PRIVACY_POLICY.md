# PAGE_34_PRIVACY_POLICY

**URL:** `https://securityblogs.com.au/privacy-policy/`
**Airtable table:** `SB · 34 · Privacy Policy`
**Page kind:** legal
**Sections in spec:** 4
...
Privacy policy disclosure — GDPR + Australian Privacy Principles compliant.
...
| Table | Use |
|---|---|
| `SB · 34 · Privacy Policy` | Per-section spec for `/privacy-policy/` (one row per section) |
...
|---|---|---|---|
| `GET /api/pages?where[slug][equals]=privacy-policy` | GET | ISR 60s | Page record + modules |
...
| Component | Purpose |
|---|---|
| `app/privacy-policy/page.tsx` | Server component — fetches CMS data, renders |
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/privacy-policy/page.tsx` if still hardcoded). Wait for ISR.
...
*End of PAGE_34_PRIVACY_POLICY.md*
