...
|---|---|---|
| 1 | Hero | hero |
| 2 | Mission statement | stats |
| 3 | Values grid | values |
| 4 | Team strip | rich-text |
| 5 | CTA band | cta-band |
...
| Table | Use |
|---|---|
| `SB · 26 · About Us` | Per-section spec for `/about-us/` (one row per section) |
...
|---|---|---|---|
| `GET /api/pages?where[slug][equals]=about-us` | GET | ISR 60s | Page record + modules |
...
| Component | Purpose |
|---|---|
| `app/about-us/page.tsx` | Server component — fetches CMS data, renders |
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/about-us/page.tsx` if still hardcoded). Wait for ISR.
