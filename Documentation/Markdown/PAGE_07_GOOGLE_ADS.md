...
**URL:** `https://securityblogs.com.au/services/google-ads/`
**Airtable table:** `SB · 07 · Google Ads for Security`
**Page kind:** detail
**Sections in spec:** 7
...
Service detail for Google Ads. Live ad-metrics preview, conversion funnel, remarketing visuals.
...
|---|---|---|
| 1 | Hero | hero |
| 2 | Live ad metrics demo | rich-text |
| 3 | Capabilities (funnel, remarketing) | capabilities |
...
| Table | Use |
|---|---|
| `SB · 07 · Google Ads for Security` | Per-section spec for `/services/google-ads/` (one row per section) |
...
|---|---|---|---|
| `GET /api/services?where[slug][equals]=google-ads` | GET | ISR 60s | Service record |
...
### `GET /api/services?where[slug][equals]=google-ads`
...
| Component | Purpose |
|---|---|
| `app/services/google-ads/page.tsx` | Server component — fetches CMS data, renders |
| `app/services/google-ads/*.tsx` | Component used on this page |
...
2. Navigate to `/services/google-ads/`
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/services/google-ads/page.tsx` if still hardcoded). Wait for ISR.
