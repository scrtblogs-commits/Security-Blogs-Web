# PAGE_17_SECURITY_TRENDS_2026

**URL:** `https://securityblogs.com.au/knowledge-hub/security-trends-2026/`
**Airtable table:** `SB · 17 · Security Trends 2026`
**Page kind:** landing
**Sections in spec:** 4
...
Year-in-review and forward-looking trends report.
...
|---|---|---|
| 1 | Hero | hero |
| 2 | Trend tabs | tabs (client) |
| 3 | Trend cards | grid (server) |
| 4 | CTA band | cta-band |
...
| Table | Use |
|---|---|
| `SB · 17 · Security Trends 2026` | Per-section spec for `/knowledge-hub/security-trends-2026/` (one row per section) |
...
|---|---|---|---|
| `GET /api/pages?where[slug][equals]=security-trends-2026` | GET | ISR 60s | Page record + modules |
...
```json
{
  "docs": [{
    "id": "rec…",
    "slug": "security-trends-2026",
    "title": "Security Trends 2026",
    "modules": [
...
| Component | Purpose |
|---|---|
| `app/knowledge-hub/security-trends-2026/page.tsx` | Server component — fetches CMS data, renders |
| `app/knowledge-hub/security-trends-2026/TrendTabs.tsx` | Client component — interactive tabs |
...
2. Navigate to `/knowledge-hub/security-trends-2026/`
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/knowledge-hub/security-trends-2026/page.tsx` if still hardcoded). Wait for ISR.
...
*End of PAGE_17_SECURITY_TRENDS_2026.md*
