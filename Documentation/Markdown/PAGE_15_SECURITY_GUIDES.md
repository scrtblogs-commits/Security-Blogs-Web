# PAGE_15_SECURITY_GUIDES

**URL:** `https://securityblogs.com.au/knowledge-hub/security-guides/`
**Airtable table:** `SB · 15 · Security Guides`
**Page kind:** listing
**Sections in spec:** 3
...
How-to guides for security industry professionals.
...
| Table | Use |
|---|---|
| `SB · 15 · Security Guides` | Per-section spec for `/knowledge-hub/security-guides/` (one row per section) |
...
|---|---|---|---|
| `GET /api/posts?where[category][equals]=security-guides` | GET | ISR 60s | Post list |
...
| Component | Purpose |
|---|---|
| `app/knowledge-hub/security-guides/page.tsx` | Server component — fetches CMS data, renders |
...
2. Navigate to `/knowledge-hub/security-guides/`
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/knowledge-hub/security-guides/page.tsx` if still hardcoded). Wait for ISR.
...
*End of PAGE_15_SECURITY_GUIDES.md*
