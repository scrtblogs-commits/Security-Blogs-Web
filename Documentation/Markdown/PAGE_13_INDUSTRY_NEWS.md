# PAGE_13_INDUSTRY_NEWS

**URL:** `https://securityblogs.com.au/knowledge-hub/industry-news/`
**Airtable table:** `SB · 13 · Industry News`
**Page kind:** listing
**Sections in spec:** 4
...
Curated security industry news, with tabbed view by source/type.
...
|---|---|---|
| 1 | Hero | hero |
| 2 | News tabs | tabs (client) |
| 3 | News cards | grid (server) |
| 4 | CTA band | cta-band |
...
| Table | Use |
|---|---|
| `SB · 13 · Industry News` | Per-section spec for `/knowledge-hub/industry-news/` (one row per section) |
...
|---|---|---|---|
| `GET /api/posts?where[category][equals]=industry-news` | GET | ISR 60s | Post list |
...
| Component | Purpose |
|---|---|
| `app/knowledge-hub/industry-news/page.tsx` | Server component — fetches CMS data, renders |
| `app/knowledge-hub/industry-news/NewsTabs.tsx` | Client component — interactive tabs |
...
2. Navigate to `/knowledge-hub/industry-news/`
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/knowledge-hub/industry-news/page.tsx` if still hardcoded). Wait for ISR.
...
*End of PAGE_13_INDUSTRY_NEWS.md*
