...
**URL:** `https://securityblogs.com.au/contact/`
**Airtable table:** `SB · 27 · Contact`
**Page kind:** form
**Sections in spec:** 5
...
Primary contact + free-audit request form. Most-used form on the site.
...
|---|---|---|
| 1 | Hero | hero |
| 2 | Contact form | form (client component) |
| 3 | Direct contact info | rich-text |
| 4 | Map (HQ) | rich-text |
| 5 | Office hours | rich-text |

## Airtable Tables

| Table | Use |
|---|---|
| `SB · 27 · Contact` | Per-section spec for `/contact/` (one row per section) |
...
| Component | Purpose |
|---|---|
| `app/contact/page.tsx` | Server component — fetches CMS data, renders |
| `components/ui/ContactForm.tsx` | Client component — handles submit, calls submitForm() |
...
| `NEXT_PUBLIC_GMAPS_KEY` | Yes | Google Maps embeds |
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/contact/page.tsx` if still hardcoded). Wait for ISR.
