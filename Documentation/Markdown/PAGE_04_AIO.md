...
**URL:** `https://securityblogs.com.au/services/aio/`
**Airtable table:** `SB · 04 · AIO (AI Optimisation)`
**Page kind:** detail
**Sections in spec:** 7
...
Service detail page for AI Optimisation. Pipeline visual + capabilities specific to ChatGPT/Perplexity/Gemini citation.
...
|---|---|---|
| 1 | Hero | hero |
| 2 | AIO pipeline diagram | rich-text |
| 3 | Capabilities (themed previews) | capabilities |
...
| Table | Use |
|---|---|
| `SB · 04 · AIO (AI Optimisation)` | Per-section spec for `/services/aio/` (one row per section) |
...
|---|---|---|---|
| `GET /api/services?where[slug][equals]=aio` | GET | ISR 60s | Service record |
...
### `GET /api/services?where[slug][equals]=aio`
...
| Component | Purpose |
|---|---|
| `app/services/aio/page.tsx` | Server component — fetches CMS data, renders |
| `app/services/aio/*.tsx` | Component used on this page |
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/services/aio/page.tsx` if still hardcoded). Wait for ISR.
