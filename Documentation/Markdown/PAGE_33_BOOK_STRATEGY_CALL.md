# PAGE_33_BOOK_STRATEGY_CALL

**URL:** `https://securityblogs.com.au/book-strategy-call/`
**Airtable table:** `SB · 33 · Book Strategy Call`
**Page kind:** form
**Sections in spec:** 4
...
|---|---|---|
| 1 | Hero | hero |
| 2 | Time slot picker | rich-text |
| 3 | Booking form | form (client component) |
| 4 | What you get strip | rich-text |

## Airtable Tables

| Table | Use |
|---|---|
| `SB · 33 · Book Strategy Call` | Per-section spec for `/book-strategy-call/` (one row per section) |
...
| Component | Purpose |
|---|---|
| `app/book-strategy-call/page.tsx` | Server component — fetches CMS data, renders |
...
2. Navigate to `/book-strategy-call/`
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/book-strategy-call/page.tsx` if still hardcoded). Wait for ISR.
...
- **Booking form** — posts to `/api/leads` (see Request/Response schemas)
...
*End of PAGE_33_BOOK_STRATEGY_CALL.md*
