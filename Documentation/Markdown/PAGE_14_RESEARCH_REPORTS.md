# PAGE_14_RESEARCH_REPORTS

**URL:** `https://securityblogs.com.au/knowledge-hub/research-reports/`
**Airtable table:** `SB · 14 · Research Reports`
**Page kind:** listing
**Sections in spec:** 4
...
Long-form research deliverables, gated-download capable.
...
|---|---|---|
| 1 | Hero | hero |
| 2 | Report cards | grid (server) |
| 3 | Download CTAs | rich-text |
| 4 | CTA band | cta-band |
...
| Table | Use |
|---|---|
| `SB · 14 · Research Reports` | Per-section spec for `/knowledge-hub/research-reports/` (one row per section) |
...
|---|---|---|---|
| `GET /api/posts?where[category][equals]=research-reports` | GET | ISR 60s | Post list |
...
| Component | Purpose |
|---|---|
| `app/knowledge-hub/research-reports/page.tsx` | Server component — fetches CMS data, renders |
...
2. Navigate to `/knowledge-hub/research-reports/`
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/knowledge-hub/research-reports/page.tsx` if still hardcoded). Wait for ISR.
...
- **Download form (email gate)** — posts to `/api/leads` (see Request/Response schemas)

---

*Notes:* Gated-download form posts to /api/leads with source='research-download'.

*End of PAGE_14_RESEARCH_REPORTS.md*
