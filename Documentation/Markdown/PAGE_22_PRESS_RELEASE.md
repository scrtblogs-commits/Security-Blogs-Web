# PAGE_22_PRESS_RELEASE

**URL:** `https://securityblogs.com.au/publish-with-us/press-release/`
**Airtable table:** `SB · 22 · Press Release Distribution`
**Page kind:** landing
**Sections in spec:** 5
...
Press release distribution service for security industry brands.
...
| Table | Use |
|---|---|
| `SB · 22 · Press Release Distribution` | Per-section spec for `/publish-with-us/press-release/` (one row per section) |
...
|---|---|---|---|
| `GET /api/pages?where[slug][equals]=press-release` | GET | ISR 60s | Page record + modules |
...
| Component | Purpose |
|---|---|
| `app/publish-with-us/press-release/page.tsx` | Server component — fetches CMS data, renders |
...
2. Navigate to `/publish-with-us/press-release/`
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/publish-with-us/press-release/page.tsx` if still hardcoded). Wait for ISR.
...
*End of PAGE_22_PRESS_RELEASE.md*
