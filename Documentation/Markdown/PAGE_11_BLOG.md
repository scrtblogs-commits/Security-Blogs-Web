...
**URL:** `https://securityblogs.com.au/knowledge-hub/blogs/`
**Airtable table:** `SB · 11 · Blog Listing`
**Page kind:** listing
**Sections in spec:** 4
...
Lists all Posts with category='blog'.
...
|---|---|---|
| 1 | Hero | hero |
| 2 | Filter chips | rich-text |
| 3 | Post grid | grid (server) |
| 4 | Pagination | rich-text |

## Airtable Tables

| Table | Use |
|---|---|
| `SB · 11 · Blog Listing` | Per-section spec for `/knowledge-hub/blogs/` (one row per section) |
...
|---|---|---|---|
| `GET /api/posts?where[category][equals]=blog` | GET | ISR 60s | Post list |
...
| Component | Purpose |
|---|---|
| `app/knowledge-hub/blogs/page.tsx` | Server component — fetches CMS data, renders |
| `app/knowledge-hub/blogs/BlogGrid.tsx` | Server component — list rendering |
...
2. Navigate to `/knowledge-hub/blogs/`
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/knowledge-hub/blogs/page.tsx` if still hardcoded). Wait for ISR.
