# PAGE_24_PRODUCT_PROMOTION

**URL:** `https://securityblogs.com.au/publish-with-us/product-promotion/`
**Airtable table:** `SB · 24 · Product Promotion`
**Page kind:** landing
**Sections in spec:** 5
...
Product promotion service (review articles, comparison pieces, feature mentions).
...
|---|---|---|
| 1 | Hero | hero |
| 2 | Promo formats | form (client component) |
| 3 | Pricing | rich-text |
| 4 | Sample placements | rich-text |
| 5 | CTA band | cta-band |
...
| Table | Use |
|---|---|
| `SB · 24 · Product Promotion` | Per-section spec for `/publish-with-us/product-promotion/` (one row per section) |
...
|---|---|---|---|
| `GET /api/pages?where[slug][equals]=product-promotion` | GET | ISR 60s | Page record + modules |
...
| Component | Purpose |
|---|---|
| `app/publish-with-us/product-promotion/page.tsx` | Server component — fetches CMS data, renders |
...
2. Navigate to `/publish-with-us/product-promotion/`
...
- **Copy / hero text:** Low impact. Edit the CMS record (or `app/publish-with-us/product-promotion/page.tsx` if still hardcoded). Wait for ISR.
...
*End of PAGE_24_PRODUCT_PROMOTION.md*
