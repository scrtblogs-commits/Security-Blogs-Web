...
const guides = [
  { slug: 'the-complete-ai-visibility-playbook-for-security-brands', title: 'The complete AI visibility playbook for security brands', diff: 'Advanced', read: '24 min', excerpt: 'A full system for getting cited across ChatGPT, Gemini, Perplexity and AI Overviews.' },
  { slug: 'schema-markup-blueprint-for-security-websites', title: 'Schema markup blueprint for security websites', diff: 'Intermediate', read: '16 min', excerpt: 'Copy-paste structured data for Organization, Service, FAQ and Review across your site.' },
  { slug: 'local-seo-from-zero-to-local-pack', title: 'Local SEO from zero to local pack', diff: 'Beginner', read: '14 min', excerpt: 'Set up Google Business Profile, service-area pages and reviews the right way.' },
  { slug: 'building-topical-authority-with-content-clusters', title: 'Building topical authority with content clusters', diff: 'Intermediate', read: '18 min', excerpt: 'Architect pillar and cluster pages that rank and feed answer-engine retrieval.' },
  { slug: 'technical-seo-audit-step-by-step', title: 'Technical SEO audit, step by step', diff: 'Advanced', read: '22 min', excerpt: 'Crawl budget, indexation, Core Web Vitals and render checks with a repeatable checklist.' },
  { slug: 'google-ads-for-security-campaign-architecture', title: 'Google Ads for security: campaign architecture', diff: 'Intermediate', read: '15 min', excerpt: 'Campaign and ad-group structure, match types and landing pages built for ROAS.' },
  { slug: 'earning-links-from-security-publications', title: 'Earning links from security publications', diff: 'Intermediate', read: '13 min', excerpt: 'Outreach, digital PR and resource link strategies that compound domain authority.' },
  { slug: 'measuring-ai-citation-rate-and-share-of-voice', title: 'Measuring AI citation rate and share of voice', diff: 'Advanced', read: '17 min', excerpt: 'Track how often each engine names your brand and benchmark against competitors.' },
]
      ...
      <section className="section">
        <div className="container">
          ...
          <Stagger style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 20 }}>
            {guides.map((g) => (
              <Item key={g.title}>
                <a href={`/knowledge-hub/security-guides/${g.slug}/`} className="card" style={{ display: 'flex', flexDirection: 'column', height: '100%', textDecoration: 'none' }}>
