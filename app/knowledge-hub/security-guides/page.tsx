      ...
      <HeroBg>
        ...
        >
          <div style={{ padding: 28 }}>
            ...
            <Link href="/knowledge-hub/security-guides/ai-visibility-playbook-security-brands/" className="accent" style={{ fontWeight: 600, fontSize: 15 }}>
              Read the guide →
            </Link>
          </div>
        </ContainerScroll>
      ...
      <section className="section">
        <div className="container">
          ...
          <Stagger style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 20 }}>
            {guides.map((g) => (
              <Item key={g.slug}>
                <Link href={`/knowledge-hub/security-guides/${g.slug}/`} className="card" style={{ display: 'flex', flexDirection: 'column', height: '100%', textDecoration: 'none' }}>
